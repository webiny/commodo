...
(async () => {
    try {
        ...
        console.log(
            cyan(
                `Triggering a GitHub workflow that will release and publish Commodo of the "${argv.branch}" branch.`
            )
        );
        ...
        console.log(green("See https://github.com/webiny/commodo/actions for action details."));
    } catch (e) {
